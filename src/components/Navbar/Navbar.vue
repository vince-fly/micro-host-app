...
import Screenfull from '@/components/Screenfull/index.vue'; // 引入菜单组件
import Sidebar from './Topbar/index.vue'; // 引入主题
import ThemePicker from '@/components/ThemePicker/index.vue';

// import { removeToken } from '@/utils/auth';
import { Component, Vue, Mixins, Prop } from 'vue-property-decorator';
import { Getter } from 'vuex-class';
@Component({name: 'Navbar', components: {Screenfull,
    Sidebar,
    ThemePicker}})
export default class extends Vue {
  ...
  @Getter('avatar') public avatar: any;
  @Getter('device') public device: any;
