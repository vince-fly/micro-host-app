...
function getAuthUrl(): string {
  ...
  return `${Auth.PASSPORT_HOST}?client_id=${Auth.APPLICATION_ID}&response_type=token&state=ee604f1f-eb5c-4165-a3e0-a9f0fb774dc1&redirect_uri=${encodeURIComponent(Auth.DOMAIN_NAME)}`
}
